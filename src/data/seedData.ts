...
export const initialPersonnel: User[] = [
  ...
  },
  {
    ...
    workgroupId: 'wg-04',
    responsibility: 'หัวหน้างานป้องกันและควบคุมโรคและระบาดวิทยา, คัดกรองมะเร็งลำไส้ใหญ่ (FIT Test), เครือข่าย NCD, งานระบาดวิทยา และทีม SRRT',
    phone: '081-197-4316',
    email: 'aekapun.k@phonnahospital.go.th',
    role: 'head',
